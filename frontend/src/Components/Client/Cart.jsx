...
//     const itemQty = qty[item.productId] || item.qty || item.quantity || 1;
...
//     // 🔥 FIXED STRUCTURE FOR BACKEND
//     const updatedCart = userCart.map((item) => ({
//       product: item.productId, // ✅ FIX
//       image: item.image,
//       title: item.title,
//       price: Number(item.price),
//       quantity: qty[item.productId] || item.qty || item.quantity || 1, // ✅ FIX
//     }));
